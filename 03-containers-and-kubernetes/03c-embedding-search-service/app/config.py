...
MLFLOW_TRACKING_USERNAME = os.getenv("MLFLOW_TRACKING_USERNAME", "student_melika_nobakhtian")
...
STUDENT_USERNAME = os.getenv("STUDENT_USERNAME") or os.getenv("MLFLOW_TRACKING_USERNAME") or "student_unknown"
